<template>
  <div>
    <el-table
      ...
      border
    >
      <el-table-column label="Номер" prop="index" width="77"> </el-table-column>
      <el-table-column label="Наименование" width="279">
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="right" width="370">
            <div>
              <div
                style="text-align: right; margin: 0; padding: 4px 4px 0px 0px"
              >
                <i
                  class="el-icon-edit"
                ...
                <i
                  class="el-icon-close"
                  style="margin-left: 20px; padding: 8px 0px"
                  @click="visible = false"
                ></i>
              </div>
              <div style="padding: 3px 12px 15px 12px">
                ...
                <p style="padding: 7px 5px; line-height: 1.4">
                  {{ getText(scope.row.description) }}
                </p>
              </div>
